    ...
    return (
      <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4 animate-fade-in">
        <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] shadow-2xl max-w-md w-full p-10 relative animate-modal-pop overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-orange-500 to-orange-500" />
          <button
            onClick={onClose}
          ...
          <div className="text-center">
            <div className="w-24 h-24 bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-orange-500/20 rotate-3">
      ...
      <div className="bg-slate-950 rounded-[3rem] shadow-[0_0_80px_rgba(0,0,0,0.5)] max-w-5xl w-full flex overflow-hidden animate-modal-pop border border-slate-900 relative">
        ...
        <div className="hidden lg:flex w-2/5 bg-slate-900 p-12 flex-col justify-between relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full opacity-10">
            <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-orange-600 rounded-full blur-[120px]" />
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-16">
              ...
              <span className="text-xl font-black text-white italic tracking-tighter uppercase">
                CAB<span className="text-orange-600">ENGINE</span>
              </span>
            </div>

            <h1 className="text-5xl font-black text-white mb-6 italic leading-[0.95] uppercase">
              Precision <br />
              <span className="text-orange-600">Engineering</span> <br />
              Simplified.
            </h1>
          ...
          <div className="relative z-10 space-y-6">
            <div className="flex items-center gap-4 group">
              ...
              <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest group-hover:text-orange-600 transition-colors">Automated Cut Lists & Nesting</span>
            </div>
            <div className="flex items-center gap-4 group">
              <div className="w-6 h-6 rounded-full border-2 border-orange-500 flex items-center justify-center">
                <CheckCircle2 size={12} className="text-orange-600" />
              </div>
              <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest group-hover:text-orange-600 transition-colors">Instant 3D Visualization</span>
            </div>
            <div className="flex items-center gap-4 group">
              <div className="w-6 h-6 rounded-full border-2 border-orange-500 flex items-center justify-center">
                <CheckCircle2 size={12} className="text-orange-600" />
              </div>
              <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest group-hover:text-orange-600 transition-colors">Direct Manufacturing DXF Output</span>
            </div>
          </div>
        </div>
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-6">
                  <div className="relative group">
                    <input
                      ...
                      className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl py-5 px-6 text-center text-3xl font-black tracking-[0.5em] text-orange-600 focus:ring-2 focus:ring-amber-500/20 focus:border-orange-500 outline-none transition-all placeholder:text-slate-800 placeholder:tracking-normal placeholder:text-sm"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-orange-600 hover:bg-orange-500 text-white font-black py-5 rounded-2xl transition-all disabled:opacity-30 flex items-center justify-center gap-3 uppercase tracking-widest text-xs shadow-xl shadow-orange-500/20 active:scale-[0.98]"
                  >
                  ...
                  <div className="text-center">
                    <button
                      ...
                      disabled={resending}
                      className="text-[10px] font-black text-slate-500 hover:text-orange-600 uppercase tracking-widest transition-all"
                    >
              ...
              <>
                <div className="mb-12">
                  <h2 className="text-5xl font-black text-white italic tracking-tighter uppercase mb-2">
                    {mode === 'login' ? 'Welcome' : 'Get'} <span className="text-orange-600">{mode === 'login' ? 'Back' : 'Started'}</span>
                  </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-4">
                    {mode === 'signup' && (
                      <>
                        {/* 1. Email Address */}
                        <div className="relative group">
                          <Mail className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within:text-orange-600 transition-colors" size={20} />
                          <input
                            type="email"
                            value={email}
                            ...
                            className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl py-4 pl-14 pr-6 text-white font-medium focus:ring-2 focus:ring-amber-500/20 focus:border-orange-500 outline-none transition-all placeholder:text-slate-600"
                          />
                        </div>
 
                        {/* 2. Phone (Optional) */}
                        <div className="relative group phone-input-container flex items-center bg-slate-900/50 border border-slate-800 rounded-2xl focus-within:ring-2 focus-within:ring-amber-500/20 focus-within:border-orange-500 transition-all px-4">
                          <PhoneInput
                            international
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="relative group">
                            <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within:text-orange-600 transition-colors" size={20} />
                            <input
                              ...
                              className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl py-4 pl-14 pr-12 text-white font-medium focus:ring-2 focus:ring-amber-500/20 focus:border-orange-500 outline-none transition-all placeholder:text-slate-600"
                            />
                            <button
                              type="button"
                              onClick={() => setShowPassword(!showPassword)}
                              className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-600 hover:text-orange-600 transition-colors"
                            >
                          ...
                          <div className="relative group">
                            <input
                              ...
                              minLength={6}
                              placeholder="Confirm"
                              className="w-full bg-slate-900/50 border border-slate-800 rounded-2xl py-4 px-12 text-white font-medium focus:ring-2 focus:ring-amber-500/20 focus:border-orange-500 outline-none transition-all placeholder:text-slate-600"
                            />
                            <button
                              type="button"
                              onClick={() => setShowPassword(!showPassword)}
                    ...
                    {mode === 'signup' && (
                      <div className="flex items-center gap-4 bg-slate-900/30 p-4 rounded-2xl border border-slate-800/50">
                        ...
                        <label htmlFor="terms-check" className="text-[11px] font-medium text-slate-500">
                          I agree to the <button type="button" onClick={onNavigateToPolicy} className="text-orange-600 font-bold hover:underline">TERMS & CONDITIONS</button> and privacy policy.
                        </label>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mt-12 text-center">
                    <button
                      ...
                      className="text-[11px] font-black text-slate-500 hover:text-orange-600 uppercase tracking-[0.2em] transition-colors"
                    >
