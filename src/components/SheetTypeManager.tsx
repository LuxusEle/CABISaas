                ...
                <tr key={sheetType.id} className="group hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                  {editingId === sheetType.id ? (
                    ...
                    <>
                      ...
                      <td className="px-3 py-4 text-slate-900 dark:text-amber-400 font-black">${sheetType.price_per_sheet.toFixed(2)}</td>
                ...
                <tr key={acc.id} className="group hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                  {editingId === acc.id ? (
                    ...
                    <>
                      ...
                      <td className="px-3 py-4 text-slate-900 dark:text-blue-400 font-black">${acc.default_amount.toFixed(2)}</td>
                      <td className="px-3 py-4 text-right">
                        <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
