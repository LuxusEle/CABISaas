...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-orange-600 hover:bg-orange-500 text-white shadow-lg shadow-orange-900/30 border border-transparent transition-all duration-200",
    ...
    outline: "bg-transparent border-2 border-orange-500 text-orange-600 hover:border-orange-400 hover:bg-orange-50 dark:border-orange-500 dark:text-orange-400 dark:hover:bg-orange-900/20"
  };
