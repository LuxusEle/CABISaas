...
const FEEDBACK_TYPES = [
  { id: 'suggestion', label: 'Suggestion', icon: Lightbulb, color: 'text-orange-600' },
    ...
    <>
      <div className={`help-button-container fixed right-6 z-50 flex items-center gap-3 print:hidden ${hasBottomNav ? 'bottom-20 md:bottom-6' : 'bottom-6'}`}>
        ...
        <button
          ...
          className="w-12 h-12 bg-slate-700 hover:bg-slate-600 disabled:bg-slate-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
        ...
        <div className="relative flex items-center gap-3">
          <AnimatePresence>
            {showPhrase && !disablePhrases && (
              ...
              >
                <span className="text-xs font-black text-orange-600 uppercase tracking-widest italic">
          ...
          <button
            ...
            className="w-12 h-12 md:w-14 md:h-14 bg-orange-600 hover:bg-orange-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group relative"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 print:hidden feedback-modal">
          ...
          <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto animate-slide-up">
            ...
            {hasUnreadReply && (
              <div className="mx-6 mt-6 p-4 bg-orange-600/10 border border-orange-500/20 rounded-2xl flex items-center gap-4 animate-pulse">
                <div className="w-10 h-10 rounded-xl bg-orange-600 flex items-center justify-center text-white shadow-lg shadow-orange-500/20 shrink-0">
                  <AlertCircle size={20} />
                </div>
                <div className="flex-1">
                  <p className="text-[10px] font-black text-orange-600 uppercase tracking-[0.2em]">Our Team Responded!</p>
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-orange-600 text-white text-[10px] font-black uppercase tracking-widest rounded-lg shadow-sm hover:shadow-md transition-all"
                >
                  Got it
                </button>
              </div>
            ...
            {isSuccess ? (
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-lg flex items-center gap-2"
                  >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                      ...
                      return (
                        <button
                          ...
                          className={`flex flex-col items-center gap-2 p-3 rounded-xl border-2 transition-all ${selectedType === type.id
                            ? 'border-orange-500 bg-amber-50 dark:bg-amber-900/20'
                  ...
                  <div className="p-3 bg-slate-100 dark:bg-slate-800 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        ...
                        className="text-sm text-indigo-700 hover:text-orange-700 font-medium"
                      >
                        Edit Annotation
                      </button>
                    </div>
                ...
                <div>
                  ...
                  {attachedFile ? (
                    <div className="flex items-center gap-3 p-3 bg-amber-50 dark:bg-amber-900/20 border border-orange-200 dark:border-orange-800 rounded-xl">
                      <div className="p-2 bg-indigo-100 dark:bg-amber-800/50 rounded-lg">
                        {attachedFile.type.startsWith('image/') ? (
                          <Image className="w-5 h-5 text-indigo-700 dark:text-orange-400" />
                        ) : (
                          <FileText className="w-5 h-5 text-indigo-700 dark:text-orange-400" />
                        )}
                      </div>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-xl hover:border-orange-500 hover:bg-amber-50 dark:hover:bg-amber-900/10 transition-all duration-200"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:border-orange-500 focus:ring-2 focus:ring-amber-500/20 outline-none resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:border-orange-500 focus:ring-2 focus:ring-amber-500/20 outline-none"
                  />
                  <p className="text-xs text-slate-500 mt-1">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-orange-600 hover:bg-orange-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
                      <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
