...
export const WallSetupCard: React.FC<WallSetupCardProps> = ({ project, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white dark:bg-slate-800 rounded-2xl border-2 border-slate-200 dark:border-slate-700 p-4 cursor-pointer hover:border-orange-500 hover:shadow-lg transition-all group mb-4"
    >
