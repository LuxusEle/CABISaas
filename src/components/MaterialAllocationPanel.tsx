            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
                ...
                <tr className="group hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                  <td className="px-2 sm:px-3 py-4">
                    <div className="flex items-center gap-2">
                      <Layers className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-orange-600 shrink-0" />
                  ...
                  <td className="px-2 sm:px-3 py-4">
                    <div className="flex gap-1.5 sm:gap-2 items-center">
                      ...
                      <label className={`cursor-pointer p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors border border-slate-200 dark:border-slate-600 ${isUploading === 'drawer' ? 'opacity-50 pointer-events-none' : ''}`} title="Upload Texture">
                        ...
                        />
                        {isUploading === 'drawer' ? <Loader2 className="w-4 h-4 animate-spin text-orange-600" /> : <Layers className="w-4 h-4 text-slate-400" />}
                      </label>
                    </div>
                  </td>
                </tr>
