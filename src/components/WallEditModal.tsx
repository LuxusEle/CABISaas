            ...
            <div className="flex items-center gap-1 p-2 bg-slate-100 dark:bg-slate-950 shrink-0 border-b border-slate-200 dark:border-slate-800">
              {localZones.map((zone) => (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-bold rounded-t-lg transition-all whitespace-nowrap ${
                    activeTab === zone.id 
                      ? 'bg-white dark:bg-slate-900 text-orange-600 shadow-sm border-t-2 border-orange-500' 
              ...
              {localZones.length < 4 && !readOnly && (
                <button
                  ...
                  className="px-4 py-2 text-sm font-bold rounded-t-lg bg-slate-200 dark:bg-slate-800 text-slate-500 hover:text-orange-600 transition-colors"
                >
                  +
                </button>
              )}
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-2">
                      <input 
                        ...
                        className="font-bold text-lg text-slate-800 dark:text-white bg-transparent border-b border-transparent hover:border-slate-300 dark:hover:border-slate-600 focus:border-orange-500 outline-none pb-0.5 transition-colors"
                      />
                    </div>
            ...
            <div className="flex gap-2 sm:gap-3">
              {readOnly ? (
                ...
                <>
                  ...
                  <button
                    onClick={handleSave}
                    className="flex items-center gap-2 px-5 sm:px-8 py-2 sm:py-2.5 bg-orange-600 hover:bg-orange-700 text-white rounded-full font-black uppercase tracking-widest shadow-lg shadow-orange-500/20 hover:scale-105 transition-all group text-xs sm:text-sm"
                  >
                    Next Step
