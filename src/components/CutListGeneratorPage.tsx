      ...
      <div className={`clg-page ${isDark ? 'lp-dark-theme' : 'lp-light-theme'}`}>
        ...
        <style>{`
          ...
          .clg-page::after {
            ...
            position: fixed;
            inset: auto -10% -22% -10%;
            height: clamp(320px, 32vh, 420px);
            z-index: -1;
            pointer-events: none;
            background: radial-gradient(circle, rgba(var(--brass-rgb), 0.12), transparent 68%);
            filter: blur(clamp(12px, 1.8vw, 24px));
          }
          .clg-page a { color: inherit; text-decoration: none; }
          .container { width: min(var(--max), calc(100% - 3.2vw)); margin-inline: auto; }

          .clg-hero { position: relative; padding: clamp(56px, 7.4vh, 100px) 0 clamp(40px, 5.2vh, 72px); }
          .clg-hero-grid { display: grid; grid-template-columns: minmax(0, 0.95fr) minmax(clamp(300px, 28vw, 380px), 1.05fr); gap: clamp(32px, 4vw, 64px); align-items: center; }
          .clg-eyebrow {
            ...
            color: var(--amber-light); font-weight: 900; font-size: clamp(10px, 0.82vw, 14px); letter-spacing: 0.02em;
            margin-bottom: clamp(16px, 2vh, 30px);
          }
          .clg-hero h1 { font-size: clamp(44px, 6.8vw, 78px); line-height: 0.94; letter-spacing: -0.075em; margin-bottom: clamp(16px, 2vh, 30px); max-width: 64vw; }
          ...
          .clg-hero-copy { color: var(--soft); font-size: clamp(15px, 1.25vw, 22px); line-height: 1.75; max-width: 50vw; margin-bottom: clamp(20px, 2.6vh, 38px); }
          .clg-hero-actions { display: flex; flex-wrap: wrap; gap: clamp(10px, 1vw, 20px); margin-bottom: clamp(14px, 1.8vh, 28px); }
          .clg-btn {
          ...
          .clg-trust-row { display: flex; flex-wrap: wrap; gap: clamp(8px, 0.9vw, 16px); align-items: center; color: var(--muted); font-size: clamp(11px, 0.85vw, 15px); }
          ...
          .clg-hero-visual { position: relative; min-height: 52vh; display: grid; place-items: center; }
          .clg-orb { position: absolute; width: clamp(280px, 28vw, 520px); height: clamp(280px, 28vw, 520px); border-radius: 50%; background: radial-gradient(circle, rgba(var(--brass-rgb), 0.22), transparent 66%); filter: blur(10px); animation: clgFloat 7s ease-in-out infinite; }
          @keyframes clgFloat { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-16px)} }
          .clg-optimizer-window {
            position: relative; width: min(100%, 54vw);
            ...
            transform: perspective(clamp(800px, 80vw, 1100px)) rotateY(-6deg) rotateX(3deg);
          }
          .clg-window-top { height: clamp(40px, 4.2vh, 56px); display: flex; align-items: center; justify-content: space-between; padding: 0 clamp(10px, 1.2vw, 22px); border-bottom: 1px solid rgba(var(--slate-400-rgb), 0.12); background: rgba(var(--slate-950-rgb), 0.42); }
          ...
          .clg-window-title { color: var(--muted); font-size: clamp(10px, 0.82vw, 14px); font-weight: 900; letter-spacing: 0.05em; text-transform: uppercase; }
          .clg-live-chip { padding: clamp(4px, 0.4vh, 7px) clamp(6px, 0.6vw, 10px); border-radius: 999px; background: rgba(var(--sage-rgb), 0.12); color: var(--sage); border: 1px solid rgba(var(--sage-rgb), 0.28); font-size: clamp(8px, 0.7vw, 12px); font-weight: 950; }
          .clg-optimizer-body { display: grid; grid-template-columns: 1fr 16vw; min-height: clamp(360px, 38vh, 520px); }
          .clg-sheet-canvas { position: relative; padding: clamp(16px, 1.8vw, 30px); overflow: hidden; background: radial-gradient(circle at 50% 42%, rgba(var(--wood-oak-rgb), 0.13), transparent 38%), linear-gradient(135deg, rgba(var(--slate-900-rgb), 0.88), rgba(var(--bg-950), 0.98)); }
           .clg-sheet-canvas::before { content: ""; position: absolute; inset: 0; background-image: linear-gradient(rgba(var(--slate-400-rgb), 0.055) 1px, transparent 1px), linear-gradient(90deg, rgba(var(--slate-400-rgb), 0.055) 1px, transparent 1px); background-size: clamp(16px, 2vw, 28px) clamp(16px, 2vw, 28px); opacity: 0.8; }
          .clg-sheet { position: relative; z-index: 1; height: clamp(300px, 32vh, 420px); border-radius: 20px; padding: clamp(12px, 1.2vw, 20px); background: linear-gradient(135deg, rgba(var(--wood-oak-rgb), 0.24), rgba(var(--wood-walnut-rgb), 0.09)); border: 1px solid rgba(var(--brass-rgb), 0.36); box-shadow: 0 20px 54px rgba(0,0,0,0.28), inset 0 0 0 1px rgba(var(--white-rgb), 0.05); display: grid; grid-template-columns: 1.1fr 0.76fr 0.6fr; grid-template-rows: repeat(5, 1fr); gap: 9px; }
          ...
          .clg-part::after { content: attr(data-label); position: absolute; left: 10px; top: 8px; color: rgba(var(--cream-rgb), 0.78); font-size: clamp(8px, 0.7vw, 12px); font-weight: 900; }
          ...
          .clg-scan-line { position: absolute; z-index: 3; left: clamp(12px, 1.6vw, 22px); right: clamp(12px, 1.6vw, 22px); height: 2px; top: 32%; background: linear-gradient(90deg, transparent, rgba(var(--brass-rgb), 0.98), transparent); filter: drop-shadow(0 0 12px rgba(var(--brass-rgb), 0.68)); animation: clgScan 3.4s ease-in-out infinite; }
          @keyframes clgScan { 0%,100%{top:18%;opacity:.25} 45%{opacity:1} 72%{top:82%;opacity:.55} }
          .clg-canvas-badge { position: absolute; z-index: 4; left: clamp(24px, 2.6vw, 44px); bottom: clamp(22px, 2.6vh, 40px); padding: clamp(9px, 0.9vh, 15px) clamp(10px, 1vw, 16px); border-radius: 14px; background: rgba(var(--slate-950-rgb), 0.72); border: 1px solid rgba(var(--slate-400-rgb), 0.16); backdrop-filter: blur(clamp(8px, 1vw, 14px)); font-size: clamp(10px, 0.8vw, 14px); color: var(--soft); box-shadow: 0 18px 40px rgba(0,0,0,0.28); }
          .clg-canvas-badge strong { display: block; color: var(--text); margin-bottom: 3px; }
          .clg-side-panel { border-left: 1px solid rgba(var(--slate-400-rgb), 0.12); background: rgba(var(--slate-950-rgb), 0.30); padding: clamp(14px, 1.4vh, 22px); }
          .clg-panel-heading { display: flex; align-items: center; justify-content: space-between; margin-bottom: clamp(10px, 1.2vh, 18px); font-size: clamp(11px, 0.85vw, 15px); font-weight: 950; }
          .clg-stat-list { display: grid; gap: clamp(6px, 0.7vh, 12px); margin-bottom: clamp(12px, 1.4vh, 20px); }
          .clg-stat-row { padding: clamp(8px, 0.9vh, 14px); border-radius: 12px; background: rgba(var(--slate-400-rgb), 0.07); border: 1px solid rgba(var(--slate-400-rgb), 0.09); }
          .clg-stat-row span { display: block; color: var(--muted); font-size: clamp(8px, 0.7vw, 12px); font-weight: 800; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 5px; }
          .clg-stat-row strong { color: var(--text); font-size: clamp(14px, 1.1vw, 19px); }
          .clg-export-box { padding: clamp(10px, 1.2vh, 18px); border-radius: 16px; background: linear-gradient(135deg, rgba(var(--wood-walnut-rgb), 0.26), rgba(var(--brass-rgb), 0.11)); border: 1px solid rgba(var(--brass-rgb), 0.32); }
          .clg-export-box strong { display: block; font-size: clamp(11px, 0.85vw, 15px); margin-bottom: clamp(8px, 0.8vh, 14px); }
          .clg-chips { display: flex; flex-wrap: wrap; gap: 7px; }
          .clg-chip { font-size: clamp(8px, 0.7vw, 12px); font-weight: 950; padding: clamp(4px, 0.5vh, 8px) clamp(6px, 0.6vw, 10px); border-radius: 8px; background: rgba(var(--white-rgb), 0.08); color: var(--amber-light); border: 1px solid rgba(var(--white-rgb), 0.10); }

          .clg-floating-note { position: absolute; z-index: 5; padding: clamp(10px, 1.1vh, 16px) clamp(10px, 1.1vw, 18px); border-radius: 16px; background: rgba(var(--bg-850), 0.78); backdrop-filter: blur(clamp(8px, 1vw, 14px)); border: 1px solid rgba(var(--slate-400-rgb), 0.17); box-shadow: 0 18px 46px rgba(0,0,0,0.30); animation: clgFloat 6s ease-in-out infinite; }
          .clg-floating-note strong { display: block; font-size: clamp(11px, 0.85vw, 15px); }
          .clg-floating-note small { display: block; color: var(--muted); margin-top: 4px; font-size: clamp(9px, 0.72vw, 13px); }
          .clg-note-a { top: 14%; left: clamp(-16px, -1vw, -8px); }
          .clg-note-b { right: clamp(-16px, -1.2vw, -8px); bottom: 18%; animation-delay: -2s; }

          .clg-metric-strip { padding: clamp(18px, 2.4vh, 36px) 0; border-top: 1px solid rgba(var(--slate-400-rgb), 0.08); border-bottom: 1px solid rgba(var(--slate-400-rgb), 0.08); background: rgba(var(--bg-850), 0.32); backdrop-filter: blur(clamp(10px, 1.2vw, 18px)); }
          .clg-metrics { display: grid; grid-template-columns: repeat(3, 1fr); gap: clamp(12px, 1.2vw, 24px); }
          ...
          .clg-metric-card { padding: clamp(18px, 2.2vh, 32px); text-align: center; transition: transform 0.22s ease, border-color 0.22s ease, background 0.22s ease; }
          .clg-metric-card:hover { transform: translateY(-6px); border-color: rgba(var(--brass-rgb), 0.34); background: var(--card-strong); }
          .clg-metric-value { color: var(--amber); font-size: clamp(32px, 3.4vw, 48px); line-height: 1; font-weight: 950; letter-spacing: -0.045em; margin-bottom: clamp(6px, 0.7vh, 12px); }
          .clg-metric-card h3 { font-size: clamp(12px, 0.9vw, 16px); margin-bottom: clamp(4px, 0.4vh, 7px); }
          .clg-metric-card p { color: var(--muted); font-size: clamp(10px, 0.8vw, 14px); line-height: 1.55; }

          .clg-page section { padding: clamp(56px, 7.4vh, 100px) 0; }
          .clg-section-heading { text-align: center; max-width: 62vw; margin: 0 auto clamp(30px, 3.8vh, 54px); }
          .clg-section-heading h2 { font-size: clamp(30px, 4vw, 48px); line-height: 1.05; letter-spacing: -0.045em; margin-bottom: clamp(10px, 1.2vh, 18px); }
          .clg-section-heading p { color: var(--muted); font-size: clamp(14px, 1.1vw, 19px); line-height: 1.7; }
          .clg-steps-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: clamp(12px, 1.2vw, 24px); }
          .clg-step-card { min-height: 20vh; padding: clamp(16px, 2vh, 30px); transition: transform 0.22s ease, border-color 0.22s ease; }
          .clg-step-card:hover { transform: translateY(-7px); border-color: rgba(var(--brass-rgb), 0.34); }
          .clg-step-number { width: clamp(36px, 3.4vh, 50px); height: clamp(36px, 3.4vh, 50px); display: grid; place-items: center; border-radius: 14px; background: linear-gradient(135deg, var(--brass), var(--wood-walnut)); color: var(--ink); font-weight: 950; box-shadow: 0 14px 28px rgba(var(--brass-rgb), 0.22); margin-bottom: clamp(14px, 1.8vh, 26px); }
          .clg-step-card h3 { font-size: clamp(15px, 1.2vw, 20px); margin-bottom: clamp(8px, 0.8vh, 14px); }
          .clg-step-card p { color: var(--muted); font-size: clamp(11px, 0.85vw, 15px); line-height: 1.65; }

          .clg-feature-grid { display: grid; grid-template-columns: 1fr 1fr; gap: clamp(14px, 1.4vw, 26px); }
          .clg-feature-card { padding: clamp(18px, 2.2vh, 32px); display: flex; gap: clamp(12px, 1.2vw, 22px); transition: transform 0.22s ease, border-color 0.22s ease, background 0.22s ease; }
          .clg-feature-card:hover { transform: translateY(-7px); border-color: rgba(var(--brass-rgb), 0.34); background: var(--card-strong); }
          .clg-icon-box { width: clamp(40px, 3.8vh, 56px); height: clamp(40px, 3.8vh, 56px); flex: 0 0 auto; display: grid; place-items: center; border-radius: 15px; background: rgba(var(--brass-rgb), 0.14); border: 1px solid rgba(var(--brass-rgb), 0.24); color: var(--amber-light); }
          .clg-feature-card h3 { font-size: clamp(15px, 1.2vw, 20px); margin-bottom: clamp(6px, 0.6vh, 10px); }
          .clg-feature-card p { color: var(--muted); font-size: clamp(11px, 0.85vw, 15px); line-height: 1.7; }

          .clg-cta-panel {
            position: relative; margin: 0 auto clamp(56px, 7vh, 100px); padding: clamp(32px, 4vh, 56px);
          ...
          .clg-cta-panel::after { content: ""; position: absolute; inset: 0; background-image: linear-gradient(rgba(var(--white-rgb), 0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(var(--white-rgb), 0.05) 1px, transparent 1px); background-size: clamp(24px, 3vw, 40px) clamp(24px, 3vw, 40px); opacity: 0.26; pointer-events: none; }
          .clg-cta-panel > * { position: relative; z-index: 1; }
          .clg-cta-panel h2 { font-size: clamp(30px, 4vw, 44px); line-height: 1.05; letter-spacing: -0.045em; margin-bottom: clamp(10px, 1.2vh, 18px); color: var(--white); }
          .clg-cta-panel p { max-width: 54vw; margin: 0 auto clamp(18px, 2.2vh, 32px); color: rgba(255,255,255,0.82); line-height: 1.7; }
          .clg-btn-cta { background: var(--white); color: #0f5138; box-shadow: 0 16px 36px rgba(0,0,0,0.18); }

          .clg-footer { border-top: 1px solid rgba(var(--slate-400-rgb), 0.08); background: rgba(var(--bg-950), 0.72); padding: clamp(20px, 2.4vh, 36px) 0; }
          .clg-footer-inner { display: flex; justify-content: space-between; align-items: center; gap: clamp(12px, 1.2vw, 24px); color: var(--muted); font-size: clamp(11px, 0.85vw, 15px); }
          .clg-brand { display: flex; align-items: center; gap: 8px; font-weight: 900; font-size: clamp(13px, 1vw, 18px); color: var(--text); }
          .clg-footer-links { display: flex; gap: clamp(14px, 1.4vw, 26px); color: var(--soft); font-weight: 700; }
          .clg-footer-links a { transition: color 0.18s ease; }
          .clg-footer-links a:hover { color: var(--text); }

          .clg-help-btn { position: fixed; right: clamp(14px, 1.8vw, 28px); bottom: clamp(14px, 1.8vh, 28px); z-index: 70; display: inline-flex; align-items: center; gap: 10px; height: clamp(40px, 4vh, 56px); padding: 0 clamp(12px, 1.2vw, 20px) 0 clamp(14px, 1.4vw, 22px); border-radius: 999px; background: rgba(var(--amber-rgb), 0.96); color: var(--ink); font-weight: 950; font-size: clamp(10px, 0.82vw, 14px); box-shadow: 0 16px 42px rgba(var(--amber-rgb), 0.32); border: 1px solid rgba(var(--white-rgb), 0.22); }
          .clg-help-btn .clg-help-q { width: clamp(22px, 2.2vh, 32px); height: clamp(22px, 2.2vh, 32px); border-radius: 50%; display: grid; place-items: center; background: rgba(var(--white-rgb), 0.18); }
          ...
          @media (max-width: 1060px) {
            ...
            .clg-hero-visual { min-height: clamp(400px, 52vh, 520px); }
            .clg-optimizer-window { transform: none; }
            .clg-steps-grid { grid-template-columns: repeat(2, 1fr); }
          }
          @media (max-width: 820px) {
            .container { width: min(100% - clamp(16px, 2.6vw, 28px), var(--max)); }
            .clg-hero { padding-top: clamp(36px, 7.4vh, 56px); }
            ...
            .clg-help-btn { width: clamp(40px, 6vw, 48px); justify-content: center; padding: 0; }
          }
          @media (max-width: 560px) {
            .clg-steps-grid { grid-template-columns: 1fr; }
            .clg-hero-visual { min-height: clamp(320px, 42vh, 420px); }
            .clg-sheet { height: clamp(240px, 30vh, 300px); }
            .clg-cta-panel { padding: clamp(24px, 4.6vh, 34px) clamp(16px, 2.8vw, 22px); }
          }
