  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {particles.map((p) => (
        <div
          key={p.id}
          className="absolute rounded-full bg-orange-600/20 animate-particle"
          style={{
            left: p.left,
            top: p.top,
            width: p.size,
    ...
    <div className="min-h-screen text-slate-900 dark:text-white overflow-x-hidden relative">
      ...
      <section className="relative min-h-screen flex items-start md:items-center justify-center md:pt-14 sm:pt-16 overflow-hidden bg-transparent">
        ...
        <div className="absolute top-20 left-8 sm:top-28 sm:left-20 z-20 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-2 sm:py-3 rounded-xl bg-gradient-to-r from-orange-500/10 via-orange-400/20 to-orange-500/10 dark:from-orange-500/20 dark:via-orange-400/30 dark:to-orange-500/20 border border-orange-300/30 dark:border-orange-400/30 animate-pulse-glow backdrop-blur-sm">
            <Download className="w-5 h-5 sm:w-7 sm:h-7 text-orange-600 flex-shrink-0" />
            <span className="text-base sm:text-xl md:text-2xl font-black text-indigo-700 dark:text-orange-400 whitespace-nowrap">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-start md:items-center justify-end min-h-screen pt-4 md:pt-12 pb-24 md:pb-40 w-full">
          <div className="w-full max-w-2xl text-center md:text-right flex flex-col items-center md:items-end md:mr-[15%] xl:mr-[-10%]">
            {/* Animated badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-indigo-100 dark:bg-orange-600/10 border border-orange-200 dark:border-orange-500/20 mb-4 sm:mb-8 animate-slide-up">
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-indigo-700 dark:text-orange-600" />
              <span className="text-xs sm:text-sm font-medium text-indigo-700 dark:text-orange-400">Professional Cabinet Design Made Simple</span>
            </div>
            ...
            <div className="bg-white/5 dark:bg-slate-900/5 backdrop-blur-xs rounded-2xl p-3 md:bg-transparent md:backdrop-blur-none md:p-0 md:rounded-none animate-slide-up w-full max-w-2xl md:ml-auto md:mr-0 mb-6 sm:mb-16 text-right">
              ...
              <div className="flex flex-col items-center md:items-end gap-2 mb-8 animate-slide-up-blink opacity-0" style={{ animationDelay: '1.2s', animationFillMode: 'forwards' }}>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg sm:text-xl md:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-orange-500 dark:from-blue-400 dark:to-orange-300">
                    SketchUp & 3D Export
                  </span>
                </div>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 max-w-lg md:ml-auto md:mr-0 mt-12 sm:mt-16 animate-slide-up px-4 sm:px-0" style={{ animationDelay: '1.4s' }}>
              {[
                ...
                <div key={i} className="text-center">
                  <div className="text-xl sm:text-2xl md:text-3xl font-black text-orange-600">{stat.value}</div>
          ...
          <div className="grid md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <FloatingElement key={i} delay={i * 200}>
                <div className="group relative p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-white/10 dark:bg-slate-900/40 backdrop-blur-sm border border-slate-200/50 dark:border-slate-800/50 hover:border-orange-500/50 transition-all duration-500 hover:transform hover:-translate-y-2 shadow-sm dark:shadow-none">
                  ...
                  <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-r from-orange-500/0 via-orange-500/5 to-orange-500/0 opacity-0 group-hover:opacity-100 transition-opacity animate-shimmer" />
                </div>
              </FloatingElement>
            ))}
          </div>
      ...
      <section id="pricing" className="relative py-16 sm:py-24 bg-white/40 dark:bg-slate-900/40 backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-3xl mx-auto">
            ...
            {/* Pro Plan */}
            <div className="relative bg-white/10 dark:bg-slate-900/40 backdrop-blur-sm rounded-2xl shadow-xl border-2 border-orange-500 overflow-hidden transform md:-translate-y-4">
              ...
              <div className="p-6 sm:p-8">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-3 rounded-lg bg-indigo-100 dark:bg-indigo-900/30">
                    <Sparkles className="w-6 h-6 text-indigo-700 dark:text-orange-400" />
                  </div>
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-white/10 dark:bg-slate-900/40 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-slate-200/50 dark:border-slate-800/50 animate-slide-up">
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-black text-orange-600 uppercase tracking-widest mb-3">Platform Details</h3>
                ...
                <div>
                  <h3 className="text-sm font-black text-orange-600 uppercase tracking-widest mb-3">Physical Address</h3>
            ...
            <div className="bg-white/10 dark:bg-slate-900/40 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-slate-200/50 dark:border-slate-800/50 animate-slide-up" style={{ animationDelay: '200ms' }}>
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-black text-orange-600 uppercase tracking-widest mb-3">Direct Contact</h3>
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="p-2 rounded-lg bg-slate-100 dark:bg-slate-700">
                        <Menu className="w-4 h-4 text-orange-600 rotated-45" />
                      </div>
                      <div>
                        <p className="text-[10px] font-bold text-slate-400 uppercase">Phone</p>
                        <a href="tel:+94777163564" className="text-sm text-slate-900 dark:text-white font-bold hover:text-orange-600 transition-colors tracking-tight">
                          +94 777 163 564
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex flex-col">
                          <a href="mailto:support@protradee.com" className="text-sm text-slate-900 dark:text-white font-bold hover:text-orange-600 transition-colors">
                            support@protradee.com
                          </a>
                          <a href="mailto:asanke1@gmail.com" className="text-sm text-slate-900 dark:text-white font-bold mt-1 hover:text-orange-600 transition-colors">
                            asanke1@gmail.com
                          </a>
                        </div>
                      </div>
      ...
      <section id="about" className="relative py-16 sm:py-24 overflow-hidden bg-white/40 dark:bg-slate-900/40 backdrop-blur-md">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-100/50 to-orange-100/50 dark:from-orange-600/30 dark:to-orange-600/30" />
