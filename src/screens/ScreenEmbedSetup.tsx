    ...
    return (
      <button
        ...
        className={`w-full flex items-center gap-4 rounded-2xl p-4 transition-all border-2 text-left relative ${
          isActive 
            ? 'bg-orange-600/10 border-orange-500/40 text-indigo-700 dark:text-orange-400 shadow-xl' 
            : 'bg-white dark:bg-slate-900 border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700'
        }`}
      >
        <div className={`shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${
          isActive ? 'bg-orange-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'
        }`}>
          {getIcon()}
        </div>
                      ...
                      <div className={`${['walls', 'limits', 'design'].includes(activeModal as string) ? 'h-full w-full' + (activeModal === 'design' ? '' : ' px-4') : 'max-w-5xl mx-auto w-full'}`}>
                            ...
                            <div className="max-w-4xl mx-auto w-full px-6">
                              <div className="text-center mb-10 relative">
                                ...
                                <h2 className="text-4xl font-black text-slate-900 dark:text-white italic tracking-tighter uppercase mb-2 leading-tight">
                                  Kitchen <span className="text-orange-600">Configurator</span>
                                </h2>
                              ...
                              <div className="space-y-6 relative">
                                <div className="grid md:grid-cols-2 gap-6">
                                  <div className="group relative">
                                    <label className="text-[9px] font-black uppercase text-orange-600 tracking-[0.2em] mb-1.5 block ml-2 italic">Customer Name</label>
                                    <div className="relative">
                                      ...
                                      <input 
                                        className="w-full p-4 pl-14 bg-white dark:bg-slate-800/40 rounded-[1.25rem] border-2 border-slate-100 dark:border-slate-800 focus:border-orange-500 outline-none dark:text-white font-bold text-sm shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none transition-all" 
                        ...
                        {activeModal === 'preferences' && (
                          <div className="space-y-6 py-6">
                            <div className="bg-amber-50/50 dark:bg-amber-900/10 p-6 rounded-[2rem] border-2 border-orange-500/10">
                              <h4 className="text-base font-black text-amber-900 dark:text-orange-400 uppercase tracking-widest mb-1 italic">Cabinet Selection</h4>
                              <p className="text-xs text-indigo-700/70 dark:text-orange-600/50 font-medium italic">Choose which types of specialized units to include in your kitchen design.</p>
                            </div>
                              ...
                              {[
                                ...
                                <label 
                                  ...
                                  className={`flex items-start gap-4 p-5 rounded-[2rem] border-2 transition-all cursor-pointer group relative ${
                                    (project.settings.layoutPreferences?.[item.id as keyof typeof project.settings.layoutPreferences] ?? true)
                                      ? 'border-orange-500 bg-orange-600/5 shadow-md shadow-orange-500/10' 
                                ...
                                >
                                  <div className="pt-1">
                                    <input 
                                      type="checkbox" 
                                      className="w-5 h-5 rounded-lg border-2 border-slate-200 dark:border-slate-700 text-orange-600 focus:ring-amber-500 accent-amber-500 cursor-pointer"
                                   ...
                                   <div className="flex items-center gap-1">
                                     <button 
                                       ...
                                       className={`p-1.5 rounded-lg border transition-all ${
                                         canUndo 
                                           ? 'bg-white dark:bg-slate-800 text-orange-600 border-slate-200 dark:border-slate-750 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-750' 
                                  ...
                                  {project.zones.map((zone) => (
                                    <button
                                      ...
                                      className={`px-3 py-2 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all ${
                                        activeTab === zone.id
                                          ? 'bg-slate-100 dark:bg-slate-800 text-orange-600 font-black'
                                  ...
                                  <div className="flex-1 overflow-y-auto p-4 space-y-6">
                                          ...
                                          <button
                                            ...
                                            className={`py-1.5 text-[10px] font-black uppercase tracking-wider rounded-lg border transition-all ${
                                              isoViewMode === v 
                                                ...
                                                : 'bg-slate-50 dark:bg-slate-800/50 text-slate-500 border-slate-200 dark:border-slate-700 hover:border-orange-300'
                                            }`}
                                          >
                                            {v}
                                          </button>
                                      ...
                                      <label className="flex items-center justify-between cursor-pointer group">
                                        ...
                                        <div className="relative inline-flex items-center">
                                          <input
                                            ...
                                            className="sr-only peer"
                                          />
                                          <div className="w-8 h-4 bg-slate-200 dark:bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-3 after:w-3 after:transition-all peer-checked:bg-orange-600 font-sans"></div>
                                        </div>
                                      </label>
                                    </div>
                                    ...
                                    <div className="space-y-1.5 pt-2">
                                      <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-[10px] font-mono text-orange-600 font-bold">{isoDoorOpenAngle}°</span>
                                      </div>
                                      <input
                                        type="range"
                                        min="0"
                                    ...
                                    {swapMode && (
                                      <p className="text-[9px] font-black text-orange-600 uppercase animate-pulse text-center tracking-widest mt-2">
                                    ...
                                    <div className="pt-2">
                                      ...
                                      <div className="space-y-3">
                                        {[
                                          ...
                                          >
                                            <div className="w-10 h-10 flex items-center justify-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-sm group-hover:border-orange-500/50 transition-colors">
                                              {proto.icon}
                                            </div>
                                            <div className="flex-1 min-w-0">
              ...
              <div className="flex gap-4">
                {wizardSteps.indexOf(activeModal) === wizardSteps.length - 1 ? (
                  <Button 
                    ...
                    className="px-8 py-3 bg-orange-600 hover:bg-orange-700 disabled:opacity-50 text-white font-black uppercase tracking-[0.15em] rounded-2xl shadow-xl shadow-orange-500/30 text-[10px] transition-all flex items-center gap-2 h-12"
                  >
                    {isSubmitting ? (
                      <>
