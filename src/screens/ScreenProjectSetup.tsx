...
const ScreenProjectSetup = ({ onSave, onSaveProject, isDark, isUserPro }: ScreenProjectSetupProps) => {
  ...
  const StepSidebarItem = ({ step, index, isActive, isDone, isRequired }: { step: string, index: number, isActive: boolean, isDone: boolean, isRequired: boolean }) => {
    const getIcon = () => {
      ...
      if (isActive) return <ArrowRight className="text-orange-600 animate-pulse" size={18} />;
    ...
    return (
      <motion.button
        ...
        className={`w-full flex items-center gap-5 rounded-2xl transition-all border-2 text-left group overflow-hidden relative ${
          isActive 
            ? 'bg-orange-600/10 border-orange-500/40 text-indigo-700 dark:text-orange-400 shadow-xl shadow-orange-500/10 z-10' 
      ...
      >
        ...
        <div className={`shrink-0 w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
          isActive ? 'bg-orange-600 text-white shadow-lg shadow-orange-500/30' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'
        }`}>
          {getIcon()}
        </div>
        <div className="flex-1 min-w-0">
          <div className="flex justify-between items-center mb-0.5">
            ...
            {isActive && (
              <motion.span 
                ...
                className="text-[8px] font-black bg-orange-600 text-white px-2 py-0.5 rounded-full tracking-widest"
              >
                ACTIVE
              </motion.span>
            )}
          ...
          {isActive && (
            <motion.p 
              ...
              className="text-[9px] font-medium text-indigo-700/60 dark:text-orange-600/50 mt-1 italic leading-tight"
            >
            ...
            <div className="h-full w-full max-w-none transition-all duration-500 relative">
              {!activeModal ? (
                <div className="space-y-8 animate-in fade-in zoom-in duration-500 text-center py-20">
                  <div className="w-24 h-24 bg-orange-600/10 rounded-[2.5rem] flex items-center justify-center text-orange-600 mx-auto mb-6">
                    <Settings size={48} className="animate-spin-slow" />
                  </div>
                  <h1 className="text-5xl font-black text-slate-900 dark:text-white uppercase tracking-tighter italic">Ready to <span className="text-orange-600">Begin?</span></h1>
                  ...
                  <AnimatePresence initial={false} custom={direction}>
                        ...
                        <div className="max-w-4xl mx-auto w-full px-6">
                          ...
                          <div className="text-center mb-16 relative">
                            ...
                            <h2 className="text-5xl font-black text-slate-900 dark:text-white italic tracking-tighter uppercase mb-4 leading-tight">
                              Start New <span className="text-orange-600">Journey</span>
                            </h2>
                          ...
                          <div className="grid md:grid-cols-2 gap-8 relative">
                            {/* Card Decoration */}
                            <div className="absolute -top-4 -left-4 w-24 h-24 border-t-4 border-l-4 border-orange-500/20 rounded-tl-[3rem] pointer-events-none" />
                            <div className="absolute -bottom-4 -right-4 w-24 h-24 border-b-4 border-r-4 border-orange-500/20 rounded-br-[3rem] pointer-events-none" />

                            {/* Project Name & Site Address */}
                            <div className="space-y-6">
                              <div className="group relative">
                                <label className="text-[10px] font-black uppercase text-orange-600 tracking-[0.2em] mb-1.5 block ml-2 italic">Project Name</label>
                                <div className="relative">
                                  <FileText className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-orange-600 transition-colors" size={18} />
                                  <input 
                                    className="w-full p-4 pl-14 bg-white dark:bg-slate-800/40 rounded-[1.25rem] border-2 border-slate-100 dark:border-slate-800 focus:border-orange-500 outline-none dark:text-white font-bold text-base shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none transition-all placeholder:text-slate-300 dark:placeholder:text-slate-600" 
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="bg-slate-50 dark:bg-slate-800/20 rounded-[2rem] p-6 border-2 border-dashed border-slate-200 dark:border-slate-800 flex flex-col items-center justify-center text-center group hover:border-orange-500/30 transition-all">
                                <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-xl flex items-center justify-center text-orange-600 shadow-lg mb-3 rotate-3 group-hover:rotate-0 transition-transform">
                                  <Sparkles size={24} />
                                </div>
                                  ...
                                  <button
                                    ...
                                    className={`w-full py-3.5 rounded-xl font-black uppercase text-[9px] tracking-widest transition-all border-2 flex items-center justify-center gap-2 ${
                                      project.settings.workflowMode === 'advanced'
                                        ...
                                        : 'bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-orange-500'
                                    }`}
                                  >
                                    <Cpu size={14} />
                    ...
                    {activeModal === 'advanced_entry' && (
                      <div className="space-y-8 animate-in fade-in slide-in-from-right-10 duration-500">
                        <div className="bg-amber-50/50 dark:bg-amber-900/10 p-6 rounded-[2rem] border-2 border-orange-500/10 flex justify-between items-center shadow-sm">
                          <div>
                            <h4 className="text-lg font-black text-amber-900 dark:text-orange-400 uppercase tracking-widest mb-1 italic flex items-center gap-3">
                              <Cpu size={22} className="text-orange-600" /> Direct Unit Entry
                            </h4>
                            <p className="text-sm text-indigo-700/70 dark:text-orange-600/50 font-medium italic">Define your cabinetry boxes manually. Skip the solver, keep the technical accuracy.</p>
                          </div>
                          
                          <div className="flex items-center gap-12">
                            <div className="flex items-center gap-6">
                              <div className="flex flex-col text-right">
                                <span className="text-[9px] font-black uppercase text-orange-600/50 tracking-widest">Total Wall length</span>
                                <span className="text-lg font-black text-amber-900 dark:text-orange-400 italic">
                                  {calculateTotalZoneLength(project.zones[0].cabinets)}
                                  <span className="text-xs font-bold text-orange-600/50 not-italic ml-1">mm</span>
                                </span>
                              </div>
                              <div className="w-[1px] h-8 bg-orange-600/10" />
                              <div className="flex flex-col text-right">
                                <span className="text-[9px] font-black uppercase text-orange-600/50 tracking-widest">Unit Count</span>
                                <span className="text-lg font-black text-amber-900 dark:text-orange-400 italic">
                                  {project.zones[0].cabinets.length}
                                  <span className="text-xs font-bold text-orange-600/50 not-italic ml-1">boxes</span>
                                </span>
                              </div>
                            </div>
                            ...
                            <button 
                              ...
                              className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 rounded-2xl font-black uppercase text-xs tracking-widest flex items-center gap-3 transition-all shadow-xl shadow-orange-500/20 active:scale-95"
                            >
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                              {project.zones[0].cabinets.map((cab, idx) => (
                                  <tr 
                                    ...
                                    className={`group transition-all duration-700 ${
                                      highlightedCabId === cab.id 
                                        ? 'bg-orange-600/10 dark:bg-orange-600/5 ring-1 ring-amber-500/30' 
                                  ...
                                  <td className="p-6 pl-10 relative">
                                    <div className="relative">
                                      <button 
                                        ...
                                        className="flex items-center gap-2 font-black text-slate-900 dark:text-white uppercase text-xs tracking-widest hover:text-orange-600 transition-colors group"
                                      >
                                        ...
                                        <ChevronDown size={14} className={`text-slate-400 group-hover:text-orange-600 transition-transform duration-300 ${activeDropdownId === cab.id ? 'rotate-180' : ''}`} />
                                      </button>
                                          ...
                                          >
                                            {[
                                              ...
                                              return (
                                                ...
                                                >
                                                  <span className={isSelected ? 'text-white' : 'text-orange-600'}>{opt.icon}</span>
                                                  {opt.label}
                                                </button>
                                              );
                                            })}
                                  ...
                                  <td className="p-6 text-right">
                                    <input 
                                      ...
                                      className={`w-20 bg-transparent text-right outline-none transition-colors duration-300 ${
                                        cab.width !== 600 ? 'font-black text-orange-600' : 'font-bold text-slate-400 dark:text-slate-500'
                                      }`}
                                    />
                                  </td>
                                  <td className="p-6 text-right">
                                    ...
                                    {(cab.preset === PresetType.BASE_CORNER || cab.preset === PresetType.WALL_CORNER) ? (
                                      <div className="flex bg-slate-100 dark:bg-slate-800 rounded-lg p-0.5 border-2 dark:border-slate-700 min-w-[110px] mx-auto shadow-inner">
                                        <button 
                                          ...
                                          className={`flex-1 py-1 rounded-md text-[9px] font-black uppercase tracking-widest transition-all duration-300 ${cab.advancedSettings?.blindCornerSide !== 'right' ? 'bg-white dark:bg-slate-600 text-orange-600 shadow-md' : 'text-slate-400 hover:text-slate-500'}`}
                                        >
                                          Left
                                        </button>
                                        <button 
                                  ...
                                  <td className="p-6 text-center">
                                    <input 
                                      type="checkbox"
                                      className="w-5 h-5 rounded border-slate-300 dark:border-slate-700 text-orange-600 focus:ring-amber-500 accent-amber-500 cursor-pointer"
                                  ...
                                  <td className="p-6 text-center">
                                    {(cab.preset !== PresetType.BASE_CORNER && cab.preset !== PresetType.WALL_CORNER) ? (
                                      <input 
                                        type="checkbox"
                                        className="w-5 h-5 rounded border-slate-300 dark:border-slate-700 text-orange-600 focus:ring-amber-500 accent-amber-500 cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
                    ...
                    {activeModal === 'sheets' && (
                      <div className="space-y-8">
                        <div className="bg-amber-50/50 dark:bg-amber-900/10 p-4 rounded-[2rem] border-2 border-orange-500/10 mb-8">
                          <h4 className="text-base font-black text-amber-900 dark:text-orange-400 uppercase tracking-widest mb-1 italic">Inventory & Materials</h4>
                          <p className="text-sm text-indigo-700/70 dark:text-orange-600/50 font-medium italic">Configure the sheet dimensions and types for accurate cutting lists.</p>
                        </div>
                        <SheetTypeManager 
                    ...
                    {activeModal === 'hardware' && (
                      <div className="space-y-8">
                        <div className="bg-amber-50/50 dark:bg-amber-900/10 p-4 rounded-[2rem] border-2 border-orange-500/10 mb-8">
                          <h4 className="text-base font-black text-amber-900 dark:text-orange-400 uppercase tracking-widest mb-1 italic">Hardware & Fittings</h4>
                          <p className="text-sm text-indigo-700/70 dark:text-orange-600/50 font-medium italic">Select hinges, handles, and runners for your project.</p>
                        </div>
                        <SheetTypeManager 
                          currency={project.settings.currency || '$'}
                    ...
                    {activeModal === 'costs' && (
                      <div className="space-y-8 max-w-4xl mx-auto w-full">
                        <div className="bg-amber-50/50 dark:bg-amber-900/10 p-8 rounded-[2.5rem] border-2 border-orange-500/10 mb-8 flex justify-between items-center">
                          <div>
                            <h4 className="text-lg font-black text-amber-900 dark:text-orange-400 uppercase tracking-widest mb-1 italic">Project Financials</h4>
                            <p className="text-sm text-indigo-700/70 dark:text-orange-600/50 font-medium italic">Manage overheads, labor, and profit margins.</p>
                          </div>
                          <div className="text-right">
                            <label className="text-[10px] font-black uppercase text-orange-600/50 tracking-widest mb-2 block">Profit Margin</label>
                            <div className="flex items-center gap-3 bg-white dark:bg-slate-900 p-2 rounded-2xl border-2 border-orange-500/20 shadow-sm">
                              <input 
                                type="number" 
                                ...
                                className="w-16 bg-transparent text-right font-black text-xl text-orange-600 outline-none"
                              />
                              <span className="text-orange-600/50 font-bold">%</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                              ...
                              <motion.div 
                                ...
                                className={`grid grid-cols-[1fr_180px_60px] gap-4 items-center p-4 rounded-2xl border-2 transition-all shadow-sm group ${
                                  editingExpenseId === expense.id 
                                    ? 'bg-white dark:bg-slate-800 border-orange-500/50 ring-2 ring-amber-500/10' 
                                    : 'bg-white/50 dark:bg-slate-800/30 border-slate-100 dark:border-slate-800 hover:border-orange-500/30'
                                }`}
                              >
                                <input 
                                  type="text" 
                                ...
                                <div className="relative">
                                  <input 
                                    ...
                                    className={`w-full px-4 py-3 rounded-xl border-none outline-none text-right font-black transition-all ${
                                      editingExpenseId === expense.id 
                                        ? 'bg-slate-50 dark:bg-slate-900/50 text-orange-600 ring-2 ring-amber-500/20' 
                                ...
                                <div className="flex justify-end gap-2">
                                  {editingExpenseId === expense.id ? (
                                    ...
                                    <button 
                                      ...
                                      className="p-2 text-slate-400 hover:text-orange-600 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                                      title="Edit expense"
                                    >
                                      <Pencil size={18} />
                                    </button>
                          ...
                          <button 
                            ...
                            className="w-full py-6 rounded-[2rem] border-2 border-dashed border-slate-200 dark:border-slate-800 text-slate-400 hover:text-orange-600 hover:border-orange-500/50 hover:bg-amber-50/10 transition-all flex items-center justify-center gap-3 group font-black uppercase text-[11px] tracking-widest mt-6"
                          >
                    ...
                    {activeModal === 'preferences' && (
                      <div className="space-y-10">
                        <div className="bg-amber-50/50 dark:bg-amber-900/10 p-10 rounded-[3rem] border-2 border-orange-500/10">
                          <h4 className="text-xl font-black text-amber-900 dark:text-orange-400 uppercase tracking-widest mb-3 italic">Layout Smart Selection</h4>
                          <p className="text-base text-indigo-700/70 dark:text-orange-600/50 font-medium italic">Choose which functional units to include in the automated 3D generator.</p>
                        </div>
                          ...
                          {[
                            ...
                            <label 
                              ...
                              className={`flex items-start gap-6 p-8 rounded-[2.5rem] border-2 transition-all cursor-pointer group relative overflow-hidden ${
                                (project.settings.layoutPreferences?.[item.id as keyof typeof project.settings.layoutPreferences] ?? true)
                                  ? 'border-orange-500 bg-orange-600/5 shadow-xl shadow-orange-500/10' 
                            ...
                            >
                              <div className="pt-1 relative z-10">
                                <input 
                                  type="checkbox" 
                                  className="w-7 h-7 rounded-xl border-2 border-slate-200 dark:border-slate-700 text-orange-600 focus:ring-amber-500 accent-amber-500 cursor-pointer"
                              ...
                              <div className="relative z-10">
                                <h5 className={`font-black uppercase tracking-tight text-base mb-1 ${
                                  (project.settings.layoutPreferences?.[item.id as keyof typeof project.settings.layoutPreferences] ?? true)
                                    ? 'text-amber-900 dark:text-orange-400'
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/30 p-8 rounded-[2.5rem] border-2 border-slate-100 dark:border-slate-800 space-y-6">
                          <label className="flex items-center gap-4 cursor-pointer group">
                            <input
                              type="checkbox"
                              className="w-6 h-6 rounded-lg border-2 border-slate-300 dark:border-slate-600 text-orange-600 focus:ring-amber-500 accent-amber-500"
                          ...
                          {project.settings.enableTopRow && (
                            <div className="pl-10 animate-in fade-in slide-in-from-top-4 duration-300">
                              <p className="text-xs text-orange-600 font-bold italic">Top row height is automatically calculated from wall ceiling height to fit perfectly.</p>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="space-y-10">
                        <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 p-6 rounded-[2rem] border-2 border-slate-100 dark:border-slate-800">
                          <h4 className="text-sm font-black uppercase text-slate-900 dark:text-white tracking-[0.2em] flex items-center gap-3 italic">
                            <div className="w-5 h-1.5 bg-orange-600 rounded-full" /> Build Standards
                          </h4>
                          ...
                          <button 
                            ...
                            className={`flex items-center gap-2 px-6 py-3 rounded-full text-[11px] font-black uppercase tracking-[0.15em] transition-all ${
                              showAdvancedConstruction 
                                ...
                                : 'bg-white dark:bg-slate-700 text-slate-600 dark:text-slate-300 border-2 border-slate-200 dark:border-slate-600 hover:border-orange-500'
                            }`}
                          >
                        ...
                        {showAdvancedConstruction && isPro && (
                          <div className="space-y-12 pt-8 animate-in zoom-in-98 duration-300">
                            <div className="space-y-6">
                              <h4 className="text-[11px] font-black uppercase text-orange-600 tracking-widest flex items-center gap-3">
                                <div className="w-4 h-1.5 bg-orange-600 rounded-full" /> Standard Depths (mm)
                              </h4>
                            ...
                            <div className="space-y-6">
                              <h4 className="text-[11px] font-black uppercase text-orange-600 tracking-widest flex items-center gap-3">
                                <div className="w-4 h-1.5 bg-orange-600 rounded-full" /> Standard Heights (mm)
                              </h4>
                              <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="max-w-5xl mx-auto w-full px-6">
                          ...
                          <div className="text-center mb-6 relative">
                            ...
                            <h2 className="text-6xl font-black text-slate-900 dark:text-white italic tracking-tighter uppercase mb-4 leading-tight text-glow">
                              Ready for <span className="text-orange-600">{project.settings.workflowMode === 'advanced' ? 'Output' : 'Generation'}</span>
                            </h2>
                          ...
                          <div className="grid lg:grid-cols-3 gap-8 relative">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                              <div className="bg-white dark:bg-slate-900/50 rounded-[3rem] p-8 border-2 border-slate-100 dark:border-slate-800 shadow-2xl relative overflow-hidden group">
                                ...
                                <h3 className="text-xs font-black uppercase text-orange-600 tracking-[0.3em] mb-4 italic flex items-center gap-4">
                                  <div className="w-8 h-1 bg-orange-600 rounded-full" />
                                  Engineering Brief
                                </h3>
                              ...
                              <div className="bg-slate-50 dark:bg-slate-800/20 rounded-[2.5rem] p-4 border border-slate-200 dark:border-slate-800 flex items-center justify-between px-10 group">
                                <div className="flex items-center gap-6">
                                  <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center text-orange-600 shadow-lg group-hover:scale-110 transition-transform">
                                ...
                                <div className="hidden sm:flex -space-x-4">
                                  {[1, 2, 3].map(i => (
                                    <div key={i} className="w-10 h-10 rounded-full border-4 border-white dark:border-slate-900 bg-slate-200 dark:bg-slate-800 overflow-hidden shadow-md">
                                      <div className="w-full h-full bg-gradient-to-br from-orange-400 to-orange-500 opacity-40" />
                                    </div>
                                  ))}
                                </div>
                              </div>
                            ...
                            <div className="space-y-4">
                              ...
                              >
                                <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-orange-500/20 opacity-0 group-hover:opacity-100 transition-opacity" />
                                <div className="w-24 h-24 bg-orange-600 rounded-[2rem] flex items-center justify-center text-white shadow-2xl shadow-orange-500/40 relative z-10 group-hover:rotate-12 transition-transform">
                                  <Wand2 size={48} />
                                </div>
                              ...
                              <div className="bg-orange-600/5 rounded-3xl p-4 border-2 border-orange-500/10 text-center italic">
              ...
              <div className="flex gap-4">
                {wizardSteps.indexOf(activeModal as string) === wizardSteps.length - 1 ? (
                  ...
                  <Button 
                    ...
                    className="px-10 py-3 bg-orange-600 hover:bg-orange-700 text-white font-black uppercase tracking-[0.15em] rounded-2xl shadow-xl shadow-orange-500/30 text-[11px] transition-all flex items-center gap-3 group hover:scale-105 active:scale-95 h-12"
                  >
